...
public class SaveCourse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String s4=request.getParameter("dur");
        String s5=request.getParameter("fees");
        ...
        try{
            ...
            out.println("<h3>COURSE DETAILS ADDED</h3>");
            out.println("<h4><a href=centry.jsp>ADD-MORE</a></h4>");
