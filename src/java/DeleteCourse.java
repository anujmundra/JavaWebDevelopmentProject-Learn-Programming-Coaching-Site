...
public class DeleteCourse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String title=request.getParameter("courseid");
        String qr="delete from courses where courseid=?";
        try{
            ...
            out.println("<h1>Course deleted successfully!");
            out.println("<h4><a href=deletecourse.jsp>Delete-More</a></h4>");
